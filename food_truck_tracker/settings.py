"""
Django settings for food_truck_tracker project.
...
SECRET_KEY = 'django-insecure-r-(r(jmhk#uq#x@3gj0%hl%ipm^_!zigp&x4ugux+$^89*e*us'
...
ROOT_URLCONF = 'food_truck_tracker.urls'
...
WSGI_APPLICATION = 'food_truck_tracker.wsgi.application'
